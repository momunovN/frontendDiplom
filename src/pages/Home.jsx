...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      {/* Hero Section */}
      <div className="relative h-[72vh] flex items-center justify-center overflow-hidden bg-black">
        {/* Фоновое изображение через прокси */}
        {popularMovies.length > 0 && popularMovies[0].backdrop_path && (
          <img
            ...
            onError={(e) => {
              e.target.style.display = "none"; // скрываем, если даже прокси не сработал
            }}
          />
        )}
          ...
          {sessions.length === 0 ? (
            <div className="text-center py-16 bg-zinc-900 rounded-3xl">
              <p className="text-xl text-zinc-400">
                Сеансов на ближайшие дни пока нет
              </p>
            </div>
          ) : (
